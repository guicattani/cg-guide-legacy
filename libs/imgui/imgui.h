...
namespace ImGui
{
    ...
    IMGUI_API void          PlotLinesWithIndicator(const char* label, float(*values_getter)(void* data, int idx), void* data, int values_count, int values_offset = 0, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), float time = 0);
    ...
    IMGUI_API void PlotVar(const char *label, float value, bool hold_time = false, float scale_min = FLT_MAX, float scale_max = FLT_MAX, size_t buffer_size = 120);
