...
void InterfaceScene3::ShowControls()
{
  ...
  if (ImGui::CollapsingHeader("Model Matrix", ImGuiTreeNodeFlags_None))
  {
    #pragma region Model Matrix
      ...
      ImGui::InputFloat4("", (float *) &g_Scene3->inspectable_model[0], 1, inputTextFlags);
      ImGui::SameLine();
      ImGui::Text("   ");
      ImGui::SameLine();
      ...
      ImGui::InputFloat4("", (float *) &g_Scene3->inspectable_model[1], 1, inputTextFlags);
      ImGui::SameLine();
      ImGui::Text("   ");
      ImGui::SameLine();
      ...
      ImGui::InputFloat4("", (float *) &g_Scene3->inspectable_model[2], 1, inputTextFlags);
      ImGui::SameLine();
      ImGui::Text(" * ");
      ImGui::SameLine();
      ...
      ImGui::InputFloat4("", (float *) &g_Scene3->inspectable_model[3], 1, inputTextFlags);
      ImGui::SameLine();
      ImGui::Text("   ");
      ImGui::SameLine();
  ...
  if (ImGui::CollapsingHeader("View Matrix", ImGuiTreeNodeFlags_None))
  {
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->view[0], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_world[0]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->view[1], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_world[1]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->view[2], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text(" * ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_world[2]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->view[3], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_world[3]);
  ...
  if (ImGui::CollapsingHeader("Projection Matrix", ImGuiTreeNodeFlags_None))
  {
    ...
    ImGui::SameLine();
    ImGui::Text("In NDC");
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->projection[0], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_camera[0]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->projection[1], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_camera[1]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->projection[2], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text(" * ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_camera[2]);
    ...
    ImGui::InputFloat4("", (float *) &g_Scene3->camera->projection[3], 2, inputTextFlags);
    ImGui::SameLine();
    ImGui::Text("   ");
    ImGui::SameLine();
    ImGui::DragFloat("", (float *) &p_camera[3]);
